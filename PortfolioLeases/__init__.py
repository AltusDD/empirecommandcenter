...
from shared.normalize import normalize_items
        ...
        ALLOWED_SORTS  = ["start_date", "end_date", "rent_cents", "property_name", "unit_name", "tenant_name", "lease_status", "updated_at", "created_at", "lease_start", "lease_end"]
        SEARCH_COLUMNS = ["tenant_name", "unit_name", "property_name"]
        DEFAULT_SORT   = "start_date"
        CACHE_SECONDS  = 60

        VIEW = "leases_enriched_v"
