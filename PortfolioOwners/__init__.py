...
ALLOWED_SORTS   = ["owner_name","properties_count","units_count","occupancy_rate","updated_at","created_at"]
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    try:
        ...
        base_url = "%s/rest/v1/owners_summary_v" % supabase_url
        ...
        logging.exception("/portfolio/owners failed unexpectedly.")
