...
from shared.normalize import normalize_items
        ...
        ALLOWED_SORTS  = ["unit_name", "property_name", "status", "updated_at", "created_at"]
        SEARCH_COLUMNS = ["unit_name", "property_name", "address1", "city", "state"]
        DEFAULT_SORT   = "unit_name"
        CACHE_SECONDS  = 120

        VIEW = "unit_property_bridge_v"
        ...
        def main(req: func.HttpRequest) -> func.HttpResponse:
            try:
                ...
                base_url = f"{supabase_url}/rest/v1/{VIEW}"
                params, meta = build_paging_sort_search(
                    req.params,
                ...
                items = normalize_items("units", items)
                ...
                logging.exception("/portfolio/units failed")
